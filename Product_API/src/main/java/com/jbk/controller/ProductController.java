...
// ProductService service=new ProductServiceImpl();
	...
	@GetMapping("/get-product-by-productid-with-sc/{pid}")
	public ResponseEntity<PSC> getProductWithSC(@PathVariable long pid){
		PSC psc = service.getProductWithSC(pid);
		return new ResponseEntity<> (psc,HttpStatus.OK);
